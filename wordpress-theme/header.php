...
<body <?php body_class('bg-zinc-950 text-white selection:bg-brand selection:text-zinc-900'); ?>>
    <header class="fixed top-0 left-0 right-0 z-50 bg-transparent py-6 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <a href="#" class="btn-primary bg-brand px-6 py-2 rounded-full text-sm font-bold">Sign In</a>
            </div>
        </div>
    </header>
